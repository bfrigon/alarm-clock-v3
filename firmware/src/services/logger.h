...
enum {
    ...
    EVENT_FTP_CLIENT_CONNECT,
    EVENT_FTP_CLIENT_DISCONNECT,
    EVENT_FTP_SERVICE_ENABLED,
    EVENT_FTP_SERVICE_DISABLED,
    EVENT_FTP_CANNOT_ALLOCATE_MEM,
    EVENT_SD_INIT_FAIL,
    EVENT_SD_REMOVED,
    EVENT_SD_READY,
};
