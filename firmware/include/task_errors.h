...
enum {
    ...
    ERR_MQTTBROKER_UNKNOWN_HOSTNAME,
    ERR_MQTTBROKER_CANT_CONNECT,
    ERR_MQTTBROKER_NO_RESPONSE,
    ERR_MQTTBROKER_DISCONNECTED,
    ERR_MQTTCLIENT_CANT_ALLOCATE,
    ERR_MQTTCLIENT_WRITE_FAIL,
    ERR_MQTTCLIENT_READ_FAIL,
    ERR_MQTT_MALFORMED_PACKET,
    ERR_MQTTBROKER_UNEXPECTED_RESPONSE,
    ERR_MQTTBROKER_REFUSED_CONNECT,

    ERR_FTP_NO_DATA_CONNECTION,
    ERR_FTP_ALLOCATE_ERROR,
    ERR_FTP_XFER_ABORTED,
